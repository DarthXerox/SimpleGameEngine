...
namespace SimpleEngine.WorldObjects
{
    public class Mesh : IDisposable
	{
		...
		public Data.Material Material { protected set; get; }
		...
		public Mesh(ObjModel model, Texture2D colTexture, Data.Material material)
        {
			Model = model;
	...
	public class NormalMappingMesh : Mesh
	{
		...
		*/
		...
		public NormalMappingMesh(ObjModel model, Texture2D colTexture, Texture2D normalTexture, Data.Material material)
        {
			Model = model;
			TextureColor = colTexture;
