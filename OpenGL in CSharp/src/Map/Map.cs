...
namespace OpenGL_in_CSharp
{
    public class Map
    {
        ...
        public Map(int width, int height, string heightMapFile)
        {
            ...
            Console.WriteLine($"Map objects load time: {watches.ElapsedMilliseconds}ms");
            */
            ...
            HeightMap = loadHeightMapTextureTask.Result;
            ...
            Borders = new SceneObject(new Mesh(CalculateBordersObjModel(MaxX - 1, 15, MaxX / 5, 3), new Texture2D(loadWallTextureTask.Result), loadTreeTrunkMtl.Result[0]));
            ...
            BordersNormalTexture = new Texture2D(loadWallNormalTextureTask.Result);


            
            Trees = new Collidable(new NormalMappingMesh(loadTreeTrunkTask.Result, new Texture2D(loadTreeTrunkTextureTask.Result),
                new Texture2D(loadTreeTrunkNormalTextureTask.Result), loadTreeTrunkMtl.Result[0]));
            TreeLeaves = new SceneObject(new NormalMappingMesh(loadTreeLeavesTask.Result, new Texture2D(loadTreeLeavesTextureTask.Result),
                new Texture2D(loadTreeLeavesNormalTextureTask.Result), loadGrassMtl.Result[0]));
            Terrain = new Terrain(HeightMap, new Texture2D(loadWallTextureTask.Result),
                 new Texture2D(loadWallNormalTextureTask.Result), loadGrassMtl.Result[0], Vector3.Zero);
            ...
            */
            Stones = new FloatingStone(new NormalMappingMesh(loadRockTask.Result, new Texture2D(loadRockTextureTask.Result),
                new Texture2D(loadRockNormalTextureTask.Result), loadRockMtl.Result[0]), transformations);
        ...
        public Map(int width, int height)
        {
            ...
            HeightMap = Textures[FilePaths.HeightMapPath];


            Borders = new SceneObject(new Mesh(CalculateBordersObjModel(MaxX - 1, 15, MaxX / 5, 3), new Texture2D(Textures[FilePaths.TextureBrickWall]), loadTreeTrunkMtl.Result[0]));
            //AddWall(MaxX - 1, 15, MaxX / 5, 3, new Texture2D(loadWallTextureTask.Result), loadTreeTrunkMtl.Result[0]);
            Borders.AddPosition(new Vector3(0, 0, 0));
            Borders.ModelTransformations.Add(new ModelTransformations(0, -90, 0, 1, new Vector3(MaxX - 2, 0, 0)));
            Borders.ModelTransformations.Add(new ModelTransformations(0, -180, 0, 1, new Vector3(MaxX - 2, 0, MaxZ - 2)));
            ...
            Trees = new Collidable(new NormalMappingMesh(loadTreeTrunkTask.Result, new Texture2D(Textures[FilePaths.TextureTreeTrunk]),
                new Texture2D(Textures[FilePaths.BumpTexTrunk]), loadTreeTrunkMtl.Result[0]));
            TreeLeaves = new SceneObject(new NormalMappingMesh(loadTreeLeavesTask.Result, new Texture2D(Textures[FilePaths.TextureTreeLeaves3]),
            ...
            Stones = new FloatingStone(new NormalMappingMesh(loadRockTask.Result, new Texture2D(Textures[FilePaths.TextureMossyRock]),
                new Texture2D(Textures[FilePaths.BumpTexMossyRock]), loadRockMtl.Result[0]), transformations);

        }

        public Map(int width, int height, IDictionary<string, Bitmap> textures, IDictionary<string, ObjModel> models)
        {
            Width = width;
            Height = height;
            ...
            */
            ...
            Trees = new Collidable(new NormalMappingMesh(models[FilePaths.ObjTreeTrunk], new Texture2D(textures[FilePaths.TextureTreeTrunk]),
                new Texture2D(textures[FilePaths.BumpTexTrunk]), loadTreeTrunkMtl.Result[0]));
            TreeLeaves = new SceneObject(new NormalMappingMesh(models[FilePaths.ObjTreeLeaves], new Texture2D(textures[FilePaths.TextureTreeLeaves3]),
                new Texture2D(textures[FilePaths.BumpTexTreeLeaves]), loadGrassMtl.Result[0]));
            Terrain = new Terrain(HeightMap, new Texture2D(textures[FilePaths.TextureGrass4]),
                 new Texture2D(textures[FilePaths.BumpTexGrass4]), loadGrassMtl.Result[0], Vector3.Zero);
        ...
        public void AddWall(int width, int height, int texPerWidth, int texPerHeight, Texture2D colTexture, Material material)
        {
            ...
            Borders = new SceneObject(new Mesh(model, colTexture, material));
        }
